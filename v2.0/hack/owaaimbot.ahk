...
Gui Add, CheckBox, x16 y448 w160 h20 voverlayActive, 顯示自瞄運行方格
...
Gui Show, w372 h480, 喵羊特攻隱蔽自喵 v2.0
Loop {
Gui, Submit, NoHide
Sleep -1
}
...
sub5:
{
msgbox, 建議先從最低設置開始`n`nFOV範圍設定越高，自瞄範圍越大. `n`nX軸代表屏幕左右方向，Y軸代表屏幕左右方向
}
return
sub6:
{
msgbox, 代表自瞄會瞄準到人物的那個部份`n`n預設設定:(x58, y85)`n`n改X軸代表屏幕左右方向，Y軸代表屏幕左右方向，如需更請善用練習場
}
return
sub7:
{
