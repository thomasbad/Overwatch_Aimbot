...
Gui Add, Text, x220 y40 w130 h20, Run 1920 x 1080 Mode [F2]
Gui Add, Text, x220 y60 w110 h20, Restart Program [F3]
Gui Add, Text, x220 y80 w160 h20, Check Performance status [F4]
...
Gui,Add,Checkbox,x40 y70 w100 h20 vaimtype2, CapsLock
Gui,Add,Checkbox,x40 y135 w120 h20 gTrigerSub vtrigger,Enable Sniperhack
Gui Add, GroupBox, x10 y120 w160 h45, Sniper support (Trigger)
Gui Add, GroupBox, x205 y170 w160 h45, Aim Speed Control
Gui Add, GroupBox, x10 y10 w180 h100, Activation button
Gui Add, CheckBox, x20 y30 w70 h20 vaimtype, LButton
Gui Add, CheckBox, x90 y30 w70 h20 vaimtype1, Rbutton
Gui Add, Text, x225 y190 w40 h20, Sens:
Gui Add, Edit, x270 y185 w50 h20 vrx, 3
Gui Add, Button, x220 y220 w120 h20 gsub4, About Aim Speed
Gui Add, Button, x240 y300 w80 h20 gsub1, Issues?
...
Gui Add, CheckBox, x16 y448 w160 h20 voverlayActive, Show auto-aim overlay
...
Gui Add, Button, x240 y320 w80 h20 gsub2, How-to
Gui Add, Button, x240 y340 w80 h20 gsub3, Best Settings
...
Gui Add, Button, x230 y240 w100 h20 gsub5, About FoV Range
Gui Add, Button, x230 y260 w100 h20 gsub6, About Aim Settings
Gui Add, Button, x230 y280 w100 h20 gsub7, About Sniper support
Gui Show, w372 h480, MeowMewatch Undetectable Ninja aimbot v2.0
Loop {
Gui, Submit, NoHide
Sleep -1
}
...
CheckAuth:
   ...
   If (User="Error" || Email="Error" || Code <> AuthData)
  {
	...
	or you need to purchase another one) = %Fingerprint%
      ...
      ClipBoard = %S%
      MsgBox This hack needs license key to activate!Please send below info to: https://www.facebook.com/overwatchninjahack/ for pruchasement`n`n%S%`n`n(Info have auto-copied)
      ExitApp
   }
Return
