...
Gui,Add,Text,x200 y20 w130 h20,Run 1280 x 720 Mode [F1]
Gui,Add,Text,x200 y40 w140 h20,Run 1920 x 1080 Mode [F2]
Gui,Add,Text,x200 y60 w110 h20,Restart Program [F3]
Gui,Add,Text,x200 y80 w160 h20,Check Performance status [F4]
Gui,Add,Text,x200 y100 w110 h20,Pause / Resume [ALT]
...
Gui,Add,Edit,x80 y135 w50 h20 vrx,3
Gui,Add,Button,x230 y200 w100 h20 gsub4,About Aim Speed
Gui,Add,Button,x230 y220 w80 h20 gsub1,Issues?
Gui,Add,GroupBox,x10 y180 w185 h190,Misc
Gui,Add,Checkbox,x20 y200 w160 h20 vmccree,Mccree Right Click No Recoil
Gui,Add,Checkbox,x20 y220 w160 h20 vtorbjorn,Torbjorn Fast Reload
Gui,Add,Checkbox,x20 y240 w160 h20 vpharah,Pharah Fast Reload
Gui,Add,Checkbox,x20 y260 w160 h20 vreaper,Reaper Fast Reload
Gui,Add,Checkbox,x20 y280 w160 h20 vroadhog,RoadHog Fast Reload
Gui,Add,Checkbox,x20 y300 w160 h20 vroadhog1,RoadHog Combo
Gui,Add,Checkbox,x20 y320 w160 h20 vgenji,Genji combo
Gui,Add,Checkbox,x20 y340 w160 h20 vbunny,Bunnyhop
Gui,Add,Button,x230 y240 w80 h20 gsub2,How-to
Gui,Add,Button,x230 y260 w80 h20 gsub3,Best Settings
Gui,Add,Button,x230 y280 w120 h20 gsub5,About Sniper support
Gui,Add,GroupBox,x180 y120 w180 h40,Sniper support 
Gui,Add,Checkbox,x220 y135 w120 h20 gTrigerSub vtrigger,Activate sniperhack

Gui,Show,w372 h391,MeowMewatch Undetectable Ninja aimbot v1.5
Loop {
Gui, Submit, NoHide
Sleep -1
}
...
sub5:
{
msgbox, Once activated，the char will shoot once you aim at the enemy，can make good use for sniper (eg. Ana) or Char without auto-gun(eg. Mccree).
}
return
GuiClose:
ExitApp
