...
Gui,Add,Text,x200 y20 w130 h20,啟動1280 x 720模式 [F1]
Gui,Add,Text,x200 y40 w140 h20,啟動1920 x 1080模式 [F2]
Gui,Add,Text,x200 y60 w110 h20,重啟自喵 [F3]
Gui,Add,Text,x200 y80 w160 h20,觀察運行狀態 [F4]
Gui,Add,Text,x200 y100 w110 h20,暫停/繼續自喵 [ALT]
...
Gui,Add,Edit,x85 y135 w50 h20 vrx,3
Gui,Add,Button,x230 y200 w110 h20 gsub4,有關自喵速度設定
Gui,Add,Button,x230 y220 w80 h20 gsub1,有問題嗎喵?
Gui,Add,GroupBox,x10 y180 w185 h190,輔助功能
Gui,Add,Checkbox,x20 y200 w160 h20 vmccree,麥卡利右鍵自動壓槍
Gui,Add,Checkbox,x20 y220 w160 h20 vtorbjorn,托比昂快速回彈
Gui,Add,Checkbox,x20 y240 w160 h20 vpharah,法拉快速回彈
Gui,Add,Checkbox,x20 y260 w160 h20 vreaper,死神快速回彈
Gui,Add,Checkbox,x20 y280 w160 h20 vroadhog,攔路豬快速回彈
Gui,Add,Checkbox,x20 y300 w160 h20 vroadhog1,攔路豬連技(滑鼠中鍵使用)
Gui,Add,Checkbox,x20 y320 w160 h20 vgenji,源氏連技(滑鼠中鍵使用)
Gui,Add,Checkbox,x20 y340 w160 h20 vbunny,笨咩跳 (跳躍輔助)
Gui,Add,Button,x230 y240 w80 h20 gsub2,使用方法
Gui,Add,Button,x230 y260 w80 h20 gsub3,最佳設置
Gui,Add,Button,x230 y280 w80 h20 gsub5,狙擊輔助說明
Gui,Add,Text,x230 y310 w130 h150,特別感謝:黏黏大麻破解及美化UI`n`n咩<3
Gui,Add,GroupBox,x180 y120 w180 h40,狙擊輔助 
Gui,Add,Checkbox,x220 y135 w120 h20 gTrigerSub vtrigger,啟用狙擊輔助
Gui,Show,w372 h391,喵羊特攻隱蔽自喵 v1.5
Loop {
Gui, Submit, NoHide
Sleep -1
}
